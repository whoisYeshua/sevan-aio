...
export interface ProductContent {
	...
	readonly manufacturingCountriesOfOrigin: ManufacturingCountriesOfOrigin[]
...
export type ManufacturingCountriesOfOrigin =
	| 'Cambodia'
	| 'China'
	| 'Çin'
	| 'Indonesia'
...
export type View = 'A' | 'B' | 'C' | 'D' | 'E' | 'F' | 'U' | 'Y' | 'Z'
...
export type ContainerTypeEnum = 'carousel' | 'image' | 'text'
